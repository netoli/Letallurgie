...
public class gestionChapitres : MonoBehaviour
{
    ...
    private void EnchainerOuLancerCinematique()
    {
        ...
        else
        {
            ...
            // Le callback explicite gere tout ce qui arrive apres
            // la cinematique — rien n'est hardcode dans OnCinematiqueFinie.
            // (Olivier 24/05 : delai reduit de 1s a 0.5s)
            LancerCinematiqueAvecDelai(nomCine, 0.5f, () =>
            {
