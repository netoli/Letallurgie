    ...
    IPointerDownHandler, IPointerUpHandler
{
    ...
    [SerializeField] private Color couleurSelectionne;

    [Header("Couleurs image enfant")]
    [SerializeField] private Image imageEnfant;
    [SerializeField] private Color couleurImageNormale;
    [SerializeField] private Color couleurImageSurvol;
    [SerializeField] private Color couleurImageClic;
    [SerializeField] private Color couleurImageDesactive;
    ...
    public void OnPointerEnter(PointerEventData donneesEvenement)
    {
        ...
        if (bouton != null && !bouton.interactable)
            return;
        ...
        if (imageEnfant != null)
            imageEnfant.color = couleurImageSurvol;
    ...
    public void OnPointerDown(PointerEventData donneesEvenement)
    {
        ...
        if (imageEnfant != null)
            imageEnfant.color = couleurImageClic;
    ...
    public void OnPointerUp(PointerEventData donneesEvenement)
    {
        ...
        if (imageEnfant != null)
            imageEnfant.color = estSurvole ?
                couleurImageSurvol : couleurImageNormale;
    ...
    public void AppliquerCouleurDesactive()
    {
        if (imageEnfant != null)
            imageEnfant.color = couleurImageDesactive;
    }

    public void AppliquerCouleurImageNormale()
    {
        if (imageEnfant != null)
            imageEnfant.color = couleurImageNormale;
    }
