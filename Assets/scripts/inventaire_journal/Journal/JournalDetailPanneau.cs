...
//   sonore + particle system) selon les interactions du slot.
// ------------------------------------------------------------
// D�pendances :
...
public class JournalDetailPanneau : MonoBehaviour
{
    ...
    [SerializeField] ParticleSystem fxBrouillard;

    [Header("Audio")]
    public AudioSource sourceAudio;
    [SerializeField] AudioClip sonBrouillard;
    [SerializeField] float dureeFade;
    [SerializeField] float volumeMax = 0.15f;
    ...
    public void OuvrirPanneauDetail(Sprite img, string titre, string description, string insight)
    {
        ...
        // Reset et play du particle system brouillard
        if (fxBrouillard != null)
        {
            fxBrouillard.Stop(true, ParticleSystemStopBehavior.StopEmittingAndClear);
            fxBrouillard.Play();
        }
